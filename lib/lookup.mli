...
module Environment_table : S with type key = [`Id of Types.Environment.id | `Name of Types.Environment.name] and type value = Types.Environment.id

module Feature_table : S with type key = [`Id of Types.Feature.id | `Name of Types.Feature.name] and type value = Types.Feature.id
